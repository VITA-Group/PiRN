...
class TurbulenceNet(nn.Module):
    def __init__(self, 
        ...
        self.refinement2 = nn.Sequential(*[TransformerBlock(dim=int(dim*2**1), num_heads=heads[0], ffn_expansion_factor=ffn_expansion_factor, bias=bias, LayerNorm_type=LayerNorm_type) for i in range(num_refinement_blocks)])
    ...
    def forward(self, inp_img):
        ...
        out_dec_level1 = self.refinement(out)
        out_J = self.output(out_dec_level1) + inp_img
        
        out_eps = self.trans(inp_img) 
